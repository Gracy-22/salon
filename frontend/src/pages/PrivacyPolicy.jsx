...
export default function PrivacyPolicy() {
  return (
    <div className="min-h-screen bg-[#FAFAF8] text-[#111827] font-sans antialiased" data-testid="privacy-policy-page">
      {/* NAV */}
      <header className="sticky top-0 z-50 bg-[#FAFAF8]/85 backdrop-blur-xl border-b border-[#E5E7EB]/70">
        <div className="max-w-4xl mx-auto px-6 lg:px-10 h-16 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-2.5" data-testid="privacy-back-brand">
            <img
      ...
      {/* CONTENT */}
      <main className="max-w-4xl mx-auto px-6 lg:px-10 py-16 md:py-20">
        <article className="privacy-body text-[15px] leading-[1.75] text-[#374151]">
          <h1 className="font-semibold tracking-[-0.02em] text-4xl md:text-5xl text-[#111827] mb-4 leading-[1.1]">
            Privacy Policy
          </h1>
          <p className="text-sm text-[#6B7280] mb-10">Last updated: July 04, 2026</p>
          ...
          <ul>
            ...
            <li>
              ...
              &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Beutxai.
            </li>
            <li>
            ...
            <li>
              <strong>Website</strong> refers to Beutxai, accessible from{" "}
              <a
                href="https://go-run-3.emergent.host/"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://go-run-3.emergent.host/
              </a>
              .
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              you have already purchased or inquired about unless You have opted not to receive such
              information.
            </li>
            <li>
          ...
          <ul>
            ...
            <li>
              <strong>With Affiliates:</strong> We may share Your Personal Data with Our affiliates,
          ...
          <p>
            ...
            sooner when it is no longer needed for the relevant purpose. We apply different retention
            periods to different categories of Personal Data based on the purpose of processing and
            legal obligations:
          </p>
          <ul>
            <li>
          ...
          <ul>
            ...
            <li>
              ...
              consistent with our backup retention schedule and are not restored except where
              necessary for security, disaster recovery, or legal compliance.
            </li>
            <li>
              Anonymization: In some cases, We convert Personal Data into anonymous statistical data
              that cannot be linked back to You. This anonymized data may be retained indefinitely
          ...
          <ul>
            <li>
              By email:{" "}
              <a href="mailto:hr.parshtechnologies@gmail.com">hr.parshtechnologies@gmail.com</a>
            </li>
          </ul>
        </article>

        <div className="mt-16 pt-8 border-t border-[#E5E7EB] flex justify-between items-center text-sm">
          <Link
            to="/"
            className="inline-flex items-center gap-2 text-[#0F766E] hover:text-[#0b5f58] font-medium"
          >
            <ArrowLeft className="h-4 w-4" />
            Back to home
          </Link>
          <span className="text-[#6B7280]">© {new Date().getFullYear()} Beutxai</span>
        </div>
      </main>
    </div>
  );
